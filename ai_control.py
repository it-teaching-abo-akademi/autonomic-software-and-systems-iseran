...
class Executor(object):
  ...
  def update_control(self, destination, throttle, steer, brake, delta_time):
    ...
    world.debug.draw_string(carla.Location(destination.x, destination.y, destination.z),'O' , draw_shadow=False, color=carla.Color(), life_time=-1.0, persistent_lines=True)   
